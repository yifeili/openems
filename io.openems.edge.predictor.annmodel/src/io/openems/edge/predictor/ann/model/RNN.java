...
//    private static final String TEST_24 = "Test_24";
   ...
   // private static String CURRENT_TEST;
    ...
    private static int LSTM_LAYER_SIZE = 100;
...
//        FileSplit inputSplit = new FileSplit("")
        FileSplit inputSplit = new FileSplit(new File("/resources/" + CURRENT_DATASET + "/" + CURRENT_TRAIN + "/"), random);
...
//
//        File file = new File("RNN_24_hours_prediction_" + CURRENT_DATASET + "_" + EPOCHS + "_epochs" + formatter.format(date) + ".csv");
