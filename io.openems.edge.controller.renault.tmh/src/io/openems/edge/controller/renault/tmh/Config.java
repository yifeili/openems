...
@interface Config {
	...
	@AttributeDefinition(name = "ESU Level Point", description = "The ID of the ESU")
	int esuLevelPoint();

	@AttributeDefinition(name = "Inverter Level Point", description = "The ID of the Inverter")
	int inverterLevelPoint();

	@AttributeDefinition(name = "Battery Pack Level Point", description = "The ID of the Battery Pack")
	int batteryPackLevelPoint();
