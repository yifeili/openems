...
@interface Config {
	...
	@AttributeDefinition(name = "On-grid channel", description = "Address to indentify ON-grid mode.")
	String onGridChannel();

	@AttributeDefinition(name = "Off-grid channel", description = "Address to indentify OFF-grid mode.")
	String offGridChannel();
